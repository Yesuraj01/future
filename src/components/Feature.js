   ...
   <section className="bg-white dark:bg-gray-900">
    <div className="container px-6 py-10 mx-auto">
        ...
        <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-12 xl:gap-12 md:grid-cols-2 xl:grid-cols-3">
            <div className="p-8 space-y-3 border-2 border-blue-400 dark:border-blue-300 bg-black rounded-xl">
                ...
                <h1 className="text-2xl font-semibold text-white capitalize dark:text-white">elegant Dark Mode</h1>
            ...
            <div className="p-8 space-y-3 border-2 border-blue-400 dark:border-blue-300 bg-black rounded-xl">
                ...
                <h1 className="text-2xl font-semibold text-white">Easy to customiztions</h1>
            ...
            <div className="p-8 space-y-3 border-2 border-blue-400 dark:border-blue-300 bg-black rounded-xl">
                ...
                <h1 className="text-2xl font-semibold text-white capitalize">Simple & clean designs</h1>
