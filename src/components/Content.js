  ...
  import AdvBg from "../images/advBg.jpg";
  const Content = () => {
    return (
      <>
      <div className="bg-gray-200">
        <div className="lg:grid lg:grid-cols-2">
            <div className="py-24 px-10 lg:px-0 max-w-3xl lg:max-w-md mx-auto">
                <h2 className="text-4xl tracking-tight font-extrabold text-gray-600">
                    <span className="block">Ready to dive in?</span>
                    <span className="block">Begin your journey today!</span>
                </h2>
                <p className="mt-5">
                    "A journey of a thousand miles begins with a single step".
                </p>
                <div className="inline-block shadow mt-5">
                    <a href="#" className="inline-block py-3 text-white px-4 hover:bg-indigo-100 bg-indigo-600 font-medium border border-transparent rounded-md">Sign up for free</a>
                </div>
            </div>
            <div className="lg:relative lg:mt-16">
                <img className="lg:absolute lg:inset-0 h-60 w-full lg:h-full object-cover object-center lg:rounded-tl-md" src="https://images.pexels.com/photos/2559941/pexels-photo-2559941.jpeg?auto=compress&cs=tinysrgb&dpr=3&h=750&w=1260" alt="Woman workcation on the beach"/>
            </div>
        </div>
    </div>
...
<div className="relative pt-[120px] lg:pt-[150px] pb-[110px] bg-white">
      <div className="container">
        <div className="flex flex-wrap -mx-4">
          <div className="w-full lg:w-5/12 px-12">
            ...
            <div className="lg:text-right lg:ml-auto">
              <div className="relative inline-block z-10 pt-11 lg:pt-0">
                <img
                  src={AdvBg}
                  alt="hero"
                  className="max-w-full lg:ml-auto rounded-tl-lg rounded-[200px]"
